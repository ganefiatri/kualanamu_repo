...
class BusinessAdvertise extends BaseController
{
    protected $module;
    protected $path;
    ...
    public function index()
    {
        $data = [
            'module'    => $this->module,
            'path'      => $this->path,
            'act'       => 'BusinessAdvertise',
        ];
        return view($this->path . '/' . $this->module, $data);
    }

    public function contentBusinessAdvertise()
    {
