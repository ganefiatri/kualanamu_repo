...
class FlightInformation extends BaseController
{
    protected $module;
    protected $path;
    ...
    public function index()
    {
        $data = [
            'module'    => $this->module,
            'path'      => $this->path,
            'act'       => 'FlightInformation',
        ];
        return view($this->path . '/' . $this->module, $data);
    }

    public function ArrivalTabPane()
    {
    ...
    public function DepartureTabPane()
    {
        $result = json_decode($this->request->getVar("result"));
        $param = json_decode($this->request->getVar("param"));
        $data = [
