            ...
            <div class="panel-body bg-light">
                <div class="chats" data-scrollbar="true" data-height="225px">
                    <div class="left">
                        ...
                        <a href="javascript:;" class="image"><img alt="" src="<?= site_url(); ?>assets/admin/img/user/user-12.jpg" /></a>
                        <div class="message">
                            Lorem ipsum dolor sit amet, consectetuer adipiscing elit
                            volutpat. Praesent mattis interdum arcu eu feugiat.
                        </div>
                    </div>
                    <div class="right">
                        ...
                        <a href="javascript:;" class="name"><span class="label label-primary">ADMIN</span>
                            Me</a>
                        <a href="javascript:;" class="image"><img alt="" src="<?= site_url(); ?>assets/admin/img/user/user-13.jpg" /></a>
                        <div class="message">
                            Nullam posuere, nisl a varius rhoncus, risus tellus
                            hendrerit neque.
                        </div>
                    </div>
                    <div class="left">
                        ...
                        <a href="javascript:;" class="image"><img alt="" src="<?= site_url(); ?>assets/admin/img/user/user-10.jpg" /></a>
                        <div class="message">
                    ...
                    <div class="left">
                        ...
                        <a href="javascript:;" class="image"><img alt="" src="<?= site_url(); ?>assets/admin/img/user/user-14.jpg" /></a>
                        <div class="message">
                            Nullam iaculis pharetra pharetra. Proin sodales tristique
                            sapien mattis placerat.
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-xl-4 col-lg-6">
        <div class="panel panel-inverse" data-sortable-id="index-4">
            ...
            <ul class="registered-users-list">
                <li>
                    <a href="javascript:;"><img src="<?= site_url(); ?>assets/admin/img/user/user-5.jpg" alt="" /></a>
                ...
                <li>
                    <a href="javascript:;"><img src="<?= site_url(); ?>assets/admin/img/user/user-3.jpg" alt="" /></a>
                    <h4 class="username text-ellipsis">
                        Ancient Caviar
                        <small>Korean</small>
                    </h4>
                ...
                <li>
                    <a href="javascript:;"><img src="<?= site_url(); ?>assets/admin/img/user/user-1.jpg" alt="" /></a>
                    <h4 class="username text-ellipsis">
                        Marble Lungs
                        <small>Indian</small>
                    </h4>
                ...
                <li>
                    <a href="javascript:;"><img src="<?= site_url(); ?>assets/admin/img/user/user-8.jpg" alt="" /></a>
                    <h4 class="username text-ellipsis">
                        Blank Bloke
                ...
                <li>
                    <a href="javascript:;"><img src="<?= site_url(); ?>assets/admin/img/user/user-2.jpg" alt="" /></a>
                    <h4 class="username text-ellipsis">
                        Hip Sculling
                        <small>Cuban</small>
                    </h4>
                ...
                <li>
                    <a href="javascript:;"><img src="<?= site_url(); ?>assets/admin/img/user/user-6.jpg" alt="" /></a>
                    <h4 class="username text-ellipsis">
                        Flat Moon
                ...
                <li>
                    <a href="javascript:;"><img src="<?= site_url(); ?>assets/admin/img/user/user-4.jpg" alt="" /></a>
                    <h4 class="username text-ellipsis">
                        Packed Puffs
                ...
                <li>
                    <a href="javascript:;"><img src="<?= site_url(); ?>assets/admin/img/user/user-9.jpg" alt="" /></a>
                    <h4 class="username text-ellipsis">
                        Clay Hike
                        <small>Swedish</small>
                    </h4>
